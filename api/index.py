...
for p in [
    ...
    "electricity", "plants", "insects", "astronomy", "countries", "robotics", "brain", "python_kids", "ocean_explore", "earth_science", "music_adv", "mythology", "economics",
]:
...
for p in [
    ...
    "sql_advanced", "devsecops", "platform_eng", "sre", "k8s_advanced", "cloud_arch", "networking_adv",
]:
...
for p in [
    ...
    "ai_safety", "ai_rag", "ai_finetuning", "ai_multimodal", "ai_agents_adv", "ai_business",
]:
...
for p in ["pinyin", "greetings", "numbers_chinese", "food_drink",
           ...
           "colors_shapes", "weather_time", "body_health", "transport", "school", "hobbies"]:
    _CATEGORIES[p] = "Learn Chinese"

for p in ["basics", "greetings_es", "numbers_es", "food_es",
           "family_es", "travel_es", "daily_es", "culture_es",
           "colors_clothing", "weather_es", "restaurant_es", "directions_es", "health_es", "home_es"]:
